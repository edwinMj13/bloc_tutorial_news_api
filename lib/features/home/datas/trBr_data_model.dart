import 'dart:convert';
TrBrDataModel breakingDataModelFromJson(String str) => TrBrDataModel.fromJson(json.decode(str));
String breakingDataModelToJson(TrBrDataModel data) => json.encode(data.toJson());
class TrBrDataModel {
  TrBrDataModel({
      this.status, 
      this.totalResults, 
  ...
  TrBrDataModel.fromJson(dynamic json) {
    status = json['status'];
